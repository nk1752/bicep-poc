...
resource nsg 'Microsoft.Network/networkSecurityGroups@2023-04-01' = [for i in range(0, 2): {
  name: '${nsgName}${i + 1}'
  location: location
  properties: {
    securityRules: [
...
resource publicIPAddress 'Microsoft.Network/publicIPAddresses@2023-04-01' = [for i in range(0, 3): {
